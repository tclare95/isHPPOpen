        ...
        <Container className="text-white text-center">
            ...
            <Col>
              ...
              <h5>
                ...
                <span className="fw-light fst-italic">
                  Wednesday <span className="fw-bold">22nd</span> June - Sunday{" "}
                  <span className="fw-bold">26th</span> June 2022
                </span>
              </h5>
              <h5>
                ...
                {"   "}
                <span className="fw-light fst-italic">
                  Monday <span className="fw-bold">27nd</span> June - Saturday{" "}
                  <span className="fw-bold">2nd</span> July 2022
                </span>
              </h5>
              <p>
                The course is closed to the public during the competition week,
                and will have disruption during the training week. The event
                will be using the course for official team training during much
                of the day, with the course open to the public during the
                evening. Times when it will be open are below.
              </p>

              <h6>
                <span>
                  There are competitions as part of the festival of paddling
                  that are open to be public -{" "}
                  <a
                    href="https://britishcanoeingevents.org.uk/freestyle2022/festival-of-paddling/"
                    target="_blank"
          ...
          <Row className="mt-5">
            <Col>
              ...
              <h5>
                <span className="fw-light fst-italic">
                  1 Hr Slots - £7 - Different slots for competitors and non
                  competitors
                </span>
              </h5>
              <p>
                Booking for these slots is{" "}
                ...
                . Expect them to get booked up quickly, even with extended
                opening hours into the evenings. The slot checker on the site
                shows NON world champs slots{" "}
              </p>
            </Col>
          </Row>
            ...
            <Col>
              ...
              <Accordion defaultActiveKey="0">
                        ...
                        <tr>
                          ...
                          <td>
                            <a
                              ...
                              rel="noopener noreferrer"
                            >
                              Young Guns World Series, Opening Ceremony
                            </a>
                          </td>
                        </tr>
                      </tbody>
                ...
                <Accordion.Item eventKey="1">
                  ...
                  <Accordion.Body>
                    <a
                      href="https://britishcanoeingevents.org.uk/freestyle2022/schedule/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
